...
const MODE_PROMPTS: Record<GenerationMode, string> = {
  email: `You are a professional email writer. The user dictated a description of the email they want.
...
- Return ONLY the email text (no subject line header, no meta-commentary)`,
  ...
  code: `You are an expert programmer. The user described code they want generated from natural language.
...
- Return ONLY the code — no markdown fences, no explanations outside comments`,
  ...
  summary: `You are a concise summarizer. The user provided content or a topic to summarize.
...
- Return ONLY the summary text`,
  ...
  expand: `You are a writing assistant who elaborates on ideas. The user provided a topic or brief notes to expand on.
...
- Return ONLY the expanded text`,
  ...
  general: `You are an AI writing assistant. The user dictated instructions for content they want created.
...
const REFINE_PROMPT = `You are a prompt refinement assistant. The user dictated rough instructions for content they want generated.
